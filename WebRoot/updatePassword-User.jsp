  ...
  <div class="type_style">
  		...
  		<div class="type_content">
  			<form id="editUserInfo" class="form form-horizontal">
  				<input type="hidden" value="${loginUser.userId }" id="adminId"/>
  				<div class="Operate_cont clearfix">
  					<label class="form-label"> 原密码：</label>
  					<div class="formControls ">
  						<input type="password" value="${loginUser.password }" id="userLoginName" class="input-text"/>
  					</div>
  				</div>
  				<div class="Operate_cont clearfix">
  				...
  				<div class="Operate_cont clearfix">
  					...
  					<div class="formControls ">
  						<input type="password" id="configPassword" class="input-text"/>
  					</div>
  				</div>
  				<div class="">
